...
PCA_data1$age <- c(rep("OLD",12),rep("YOUNG",12),rep("OLD",12),rep("YOUNG",12))
PCA_data1$age_clonal_line <- c(rep("C32_OLD",12),rep("C32_YOUNG",12),rep("KA53_OLD",12),rep("KA53_YOUNG",12))
PCA_data1$age_diet <- c(rep("OLD_HF",6),rep("OLD_LF",6),rep("YOUNG_HF",6),rep("YOUNG_LF",6),
                    rep("OLD_HF",6),rep("OLD_LF",6),rep("YOUNG_HF",6),rep("YOUNG_LF",6))
